...
if(r(a))return r(b)&&1==b.length?a.indexOf(b,c):-1;for(;c<a.length;c++)if(c in a&&a[c]===b)return c;return-1},B=Array.prototype.forEach?function(a,b,c){Array.prototype.forEach.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=r(a)?a.split(""):a,f=0;f<d;f++)f in e&&b.call(c,e[f],f,a)},Fa=Array.prototype.map?function(a,b,c){return Array.prototype.map.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=Array(d),f=r(a)?a.split(""):a,g=0;g<d;g++)g in f&&(e[g]=b.call(c,f[g],g,a));
return e};
...
function Ha(a,b){var c=Ea(a,b);0<=c&&Array.prototype.splice.call(a,c,1)}
...
;var Ka;a:{var La=p.navigator;if(La){var Na=La.userAgent;if(Na){Ka=Na;break a}}Ka=""}function C(a){return-1!=Ka.indexOf(a)}
...
;var Ya=C("Opera"),Za=C("Trident")||C("MSIE"),$a=C("Edge"),ab=C("Gecko")&&!(-1!=Ka.toLowerCase().indexOf("webkit")&&!C("Edge"))&&!(C("Trident")||C("MSIE"))&&!C("Edge"),bb=-1!=Ka.toLowerCase().indexOf("webkit")&&!C("Edge");function cb(){var a=p.document;return a?a.documentMode:void 0}
...
var mb={};function D(){this.b="";this.f=ob}
D.prototype.ha=!0;D.prototype.ga=function(){return this.b};
function pb(a){return a instanceof D&&a.constructor===D&&a.f===ob?a.b:"type_error:SafeUrl"}
var qb=/^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i;function rb(a){if(a instanceof D)return a;a=a.ha?a.ga():String(a);qb.test(a)||(a="about:invalid#zClosurez");return sb(a)}
var ob={};function sb(a){var b=new D;b.b=a;return b}
...
ub("<!DOCTYPE html>");ub("");ub("<br>");function vb(a,b){var c=b instanceof D?b:rb(b);a.href=pb(c)}
...
var Eb=pa;var Fb=document,E=window;function Gb(a){"number"==typeof a&&(a=Math.round(a)+"px");return a}
...
;function Kb(a,b,c){var d=[],e=[];if(1==(sa(c)?2:1))return e=[b,a],B(d,function(a){e.push(a)}),Lb(e.join(" "));
...
if("undefined"!==typeof a&&!C("Trident")&&!C("MSIE")){var b=new a,c={},d=c;b.port1.onmessage=function(){if(q(c.next)){c=c.next;var a=c.na;c.na=null;a()}};
...
!ua(p.setImmediate)||p.Window&&p.Window.prototype&&!C("Edge")&&p.Window.prototype.setImmediate==p.setImmediate?(Sb||(Sb=Tb()),Sb(a)):p.setImmediate(a)}}
var $b=!1,ac=new Ub;function bc(){for(var a;a=ac.remove();){try{a.b.call(a.scope)}catch(b){Rb(b)}Qb(Wb,a)}$b=!1}
;var cc=C("Firefox"),dc=(C("Chrome")||C("CriOS"))&&!C("Edge");function F(){this.f=this.f;this.F=this.F}
F.prototype.f=!1;F.prototype.dispose=function(){this.f||(this.f=!0,this.l())};
function ec(a,b){a.f?q(void 0)?b.call(void 0):b():(a.F||(a.F=[]),a.F.push(q(void 0)?v(b,void 0):b))}
F.prototype.l=function(){if(this.F)for(;this.F.length;)this.F.shift()()};
...
function kc(a,b){if(ta(a))try{B(a,b,void 0)}catch(c){if(c!==hc)throw c;}else{a=jc(a);try{for(;;)b.call(void 0,a.next(),void 0,a)}catch(c){if(c!==hc)throw c;}}}
function lc(a){if(ta(a))return Ia(a);a=jc(a);var b=[];kc(a,function(a){b.push(a)});
return b}
...
function Ic(a){a.j||(a.j=!0,Xb(a.o,a))}
function Fc(a){var b=null;a.f&&(b=a.f,a.f=b.next,b.next=null);a.f||(a.h=null);return b}
H.prototype.o=function(){for(var a;a=Fc(this);)Gc(this,a,this.b,this.m);this.j=!1};
...
var Mc=Rb;function Dc(a){A.call(this,a)}
z(Dc,A);Dc.prototype.name="cancel";function I(a){F.call(this);this.j=1;this.h=[];this.i=0;this.b=[];this.g={};this.m=!!a}
z(I,F);k=I.prototype;k.subscribe=function(a,b,c){var d=this.g[a];d||(d=this.g[a]=[]);var e=this.j;this.b[e]=a;this.b[e+1]=b;this.b[e+2]=c;this.j=e+3;d.push(e);return e};
function Nc(a,b,c,d){if(b=a.g[b]){var e=a.b;(b=Ga(b,function(a){return e[a+1]==c&&e[a+2]==d}))&&a.D(b)}}
...
k.clear=function(a){if(a){var b=this.g[a];b&&(B(b,this.D,this),delete this.g[a])}else this.b.length=0,this.g={}};
k.l=function(){I.u.l.call(this);this.clear();this.h.length=0};function Pc(a){this.b=a}
...
Qc.prototype.set=function(a,b){Qc.u.set.call(this,a,Sc(b))};
Qc.prototype.f=function(a){a=Qc.u.get.call(this,a);if(!q(a)||a instanceof Object)return a;throw"Storage: Invalid value was encountered";};
...
z(J,Qc);J.prototype.set=function(a,b,c){if(b=Sc(b)){if(c){if(c<y()){J.prototype.remove.call(this,a);return}b.expiration=c}b.creation=y()}J.u.set.call(this,a,b)};
J.prototype.f=function(a,b){var c=J.u.f.call(this,a);if(c){var d;if(d=!b){d=c.creation;var e=c.expiration;d=!!e&&e<y()||!!d&&d>y()}if(d)J.prototype.remove.call(this,a);else return c}};function Tc(a){this.b=a}
z(Tc,J);function Uc(){}
;function Vc(){}
z(Vc,Uc);Vc.prototype.clear=function(){var a=lc(this.X(!0)),b=this;B(a,function(a){b.remove(a)})};function Wc(a){this.b=a}
...
function rd(a){a&&(a.dataset?a.dataset[nd("loaded")]="true":a.setAttribute("data-loaded","true"))}
...
function yd(a){ud[a]&&(a=ud[a],B(a,function(a){td[a]&&delete td[a]}),a.length=0)}
...
function Bd(a){var b=xd();b&&("number"==typeof a?a=[a]:r(a)&&(a=[parseInt(a,10)]),B(a,function(a){b.unsubscribeByKey(a);delete td[a]}))}
;var Cd=/\.vflset|-vfl[a-zA-Z0-9_+=-]+/,Dd=/-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/;function Ed(a,b){var c=Fd(a),d=document.getElementById(c),e=d&&od(d,"loaded"),f=d&&!e;if(e)b&&b();else{if(b){e=wd(c,b);var g=""+(b[xa]||(b[xa]=++ya));Gd[g]=e}f||(d=Hd(a,c,function(){od(d,"loaded")||(rd(d),Ad(c),R(x(zd,c),0))}))}}
...
function Fd(a){var b=document.createElement("a");vb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+Da(a)}
...
;function Td(a){"?"==a.charAt(0)&&(a=a.substr(1));a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length){var f=decodeURIComponent((e[0]||"").replace(/\+/g," "));e=decodeURIComponent((e[1]||"").replace(/\+/g," "));f in b?sa(b[f])?Ja(b[f],e):b[f]=[b[f],e]:b[f]=e}}return b}
...
function Xd(a,b){b=void 0===b?{}:b;var c=void 0;c=window.location.href;var d=K(a)[1]||null,e=$c(K(a)[3]||null);d&&e?(d=c,c=K(a),d=K(d),c=c[3]==d[3]&&c[1]==d[1]&&c[4]==d[4]):c=e?$c(K(c)[3]||null)==e&&(Number(K(c)[4]||null)||null)==(Number(K(a)[4]||null)||null):!0;for(var f in Vd){if((e=d=N(Vd[f]))&&!(e=c)){var g=a;e=f;var h=N("CORS_HEADER_WHITELIST")||{};e=(g=$c(K(g)[3]||null))?(h=h[g])?0<=Ea(h,e):!1:!0}e&&(b[f]=d)}return b}
function Yd(a,b){var c=N("XSRF_FIELD_NAME",void 0),d;b.headers&&(d=b.headers["Content-Type"]);return!b.jb&&(!$c(K(a)[3]||null)||b.withCredentials||$c(K(a)[3]||null)==document.location.hostname)&&"POST"==b.method&&(!d||"application/x-www-form-urlencoded"==d)&&!(b.B&&b.B[c])}
function Zd(a,b){var c=b.format||"JSON";b.Ca&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var d=N("XSRF_FIELD_NAME",void 0),e=N("XSRF_TOKEN",void 0),f=b.ab;f&&(f[d]&&delete f[d],a=Ud(a,f||{}));f=b.postBody||"";var g=b.B;Yd(a,b)&&(g||(g={}),g[d]=e);g&&r(f)&&(d=Td(f),Va(d,g),f=b.qa&&"JSON"==b.qa?JSON.stringify(d):bd(d));d=f||g&&!Ra(g);!Wd&&d&&"POST"!=b.method&&(Wd=!0,P(Error("AJAX request with postData should use POST")));var h=
!1,l,m=$d(a,function(a){if(!h){h=!0;l&&window.clearTimeout(l);var d=Sd(a),e=null;if(d||400<=a.status&&500>a.status)e=ae(c,a,b.ib);if(d)a:if(204==a.status)d=!0;else{switch(c){case "XML":d=0==parseInt(e&&e.return_code,10);break a;case "RAW":d=!0;break a}d=!!e}e=e||{};var f=b.context||p;d?b.P&&b.P.call(f,a,e):b.onError&&b.onError.call(f,a,e);b.Ia&&b.Ia.call(f,a,e)}},b.method,f,b.headers,b.responseType,b.withCredentials);
b.Z&&0<b.timeout&&(l=R(function(){h||(h=!0,m.abort(),window.clearTimeout(l),b.Z.call(b.context||p,m))},b.timeout))}
function ae(a,b,c){var d=null;switch(a){case "JSON":a=b.responseText;b=b.getResponseHeader("Content-Type")||"";a&&0<=b.indexOf("json")&&(d=JSON.parse(a));break;case "XML":if(b=(b=b.responseXML)?be(b):null)d={},B(b.getElementsByTagName("*"),function(a){d[a.tagName]=ce(a)})}c&&de(d);
return d}
function de(a){if(wa(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=ub(a[b]);a[c]=d}else de(a[b])}}
function be(a){return a?(a=("responseXML"in a?a.responseXML:a).getElementsByTagName("root"))&&0<a.length?a[0]:null:null}
function ce(a){var b="";B(a.childNodes,function(a){b+=a.nodeValue});
return b}
...
;var fe={},ge=0;function he(a,b){a&&(N("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)?$d(a,b,"GET","",void 0):ie(a,b))}
function ie(a,b){var c=new Image,d=""+ge++;fe[d]=c;c.onload=c.onerror=function(){b&&fe[d]&&b();delete fe[d]};
c.src=a}
;var je={value:0};
function ke(a,b,c,d,e,f){b=void 0===b?"ERROR":b;e=void 0===e?!1:e;f=f||{};f.name=c||N("INNERTUBE_CONTEXT_CLIENT_NAME",1);f.version=d||N("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0);e=window&&window.yterr||(void 0===e?!1:e)||!1;if(a&&e&&!(5<=je.value)){e=a.stacktrace;c=a.columnNumber;d=u("window.location.href");if(r(a))a={message:a,name:"Unknown error",lineNumber:"Not available",fileName:d,stack:"Not available"};else{var g=!1;try{var h=a.lineNumber||a.line||"Not available"}catch(G){h="Not available",
g=!0}try{var l=a.fileName||a.filename||a.sourceURL||p.$googDebugFname||d}catch(G){l="Not available",g=!0}a=!g&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name?a:{message:a.message||"Not available",name:a.name||"UnknownError",lineNumber:h,fileName:l,stack:a.stack||"Not available"}}e=e||a.stack;h=a.lineNumber.toString();isNaN(h)||isNaN(c)||(h=h+":"+c);if(!(le[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js"))){l=a.fileName;b={ab:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,
1E3),line:h,level:void 0===b?"ERROR":b,"client.name":f.name},B:{url:N("PAGE_NAME",window.location.href),file:l},method:"POST"};f.version&&(b["client.version"]=f.version);e&&(b.B.stack=e);for(var m in f)b.B["client."+m]=f[m];if(m=N("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(var w in m)b.B[w]=m[w];Zd("/error_204",b);le[a.message]=!0;je.value++}}}
...
;var ue=0;t("ytDomDomGetNextId",u("ytDomDomGetNextId")||function(){return++ue},void 0);var ve={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};
...
we.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var Qa=u("ytEventsEventsListeners")||{};t("ytEventsEventsListeners",Qa,void 0);var xe=u("ytEventsEventsCounter")||{count:0};t("ytEventsEventsCounter",xe,void 0);function ye(a,b,c,d){d=void 0===d?!1:d;a.addEventListener&&("mouseenter"!=b||"onmouseenter"in document?"mouseleave"!=b||"onmouseenter"in document?"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"):b="mouseout":b="mouseover");return Pa(function(e){return!!e.length&&e[0]==a&&e[1]==b&&e[2]==c&&e[4]==!!d})}
function ze(a,b,c){var d=void 0===d?!1:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=ye(a,b,c,d);if(e)return e;e=++xe.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(d){d=new we(d);if(!Cb(d.relatedTarget,function(b){return b==a}))return d.currentTarget=a,d.type=b,c.call(a,d)}:function(b){b=new we(b);
b.currentTarget=a;return c.call(a,b)};
g=ld(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),a.addEventListener(b,g,d)):a.attachEvent("on"+b,g);Qa[e]=[a,b,c,g,d];return e}
function Ae(a){a&&("string"==typeof a&&(a=[a]),B(a,function(a){if(a in Qa){var b=Qa[a],d=b[0],e=b[1],f=b[3];b=b[4];d.removeEventListener?d.removeEventListener(e,f,b):d.detachEvent&&d.detachEvent("on"+e,f);delete Qa[a]}}))}
;function Be(){if(null==u("_lact",window)){var a=parseInt(N("LACT"),10);a=isFinite(a)?y()-Math.max(a,0):-1;t("_lact",a,window);t("_fact",a,window);-1==a&&S();ze(document,"keydown",S);ze(document,"keyup",S);ze(document,"mousedown",S);ze(document,"mouseup",S);wd("page-mouse",S);wd("page-scroll",S);wd("page-resize",S)}}
function S(){null==u("_lact",window)&&Be();var a=y();t("_lact",a,window);-1==u("_fact",window)&&t("_fact",a,window);(a=u("ytglobal.ytUtilActivityCallback_"))&&a()}
function Ce(){var a=u("_lact",window);return null==a?-1:Math.max(y()-a,0)}
var De=S;function Ee(a,b,c,d,e){this.g=a;this.i=b;this.h=c;this.f=d;this.b=e}
var Fe=1;function Ge(a){var b={};void 0!==a.g?b.trackingParams=a.g:(b.veType=a.i,null!=a.h&&(b.veCounter=a.h),null!=a.f&&(b.elementIndex=a.f));void 0!==a.b&&(b.dataElement=Ge(a.b));return b}
;var He={log_event:"events",log_event2:"events",log_interaction:"interactions"},Ie=Object.create(null);Ie.log_event="GENERIC_EVENT_LOGGING";Ie.log_event2="GENERIC_EVENT_LOGGING";Ie.log_interaction="INTERACTION_LOGGING";var Je={},Ke={},Le=0,T=u("ytLoggingTransportLogPayloadsQueue_")||{};t("ytLoggingTransportLogPayloadsQueue_",T,void 0);var Me=u("ytLoggingTransportTokensToCttTargetIds_")||{};t("ytLoggingTransportTokensToCttTargetIds_",Me,void 0);var Ne=u("ytLoggingTransportDispatchedStats_")||{};
t("ytLoggingTransportDispatchedStats_",Ne,void 0);t("ytytLoggingTransportCapturedTime_",u("ytLoggingTransportCapturedTime_")||{},void 0);function Oe(a,b){Ke[a.endpoint]=b;if(a.Y){var c=a.Y;var d={};c.videoId?d.videoId=c.videoId:c.playlistId&&(d.playlistId=c.playlistId);Me[a.Y.token]=d;c=Pe(a.endpoint,a.Y.token)}else c=Pe(a.endpoint);c.push(a.payload);d=Q("web_logging_max_batch");c.length>=(Number(d||0)||20)?Qe():Re()}
function Qe(){window.clearTimeout(Le);if(!Ra(T)){for(var a in T){var b=Je[a];if(!b){var c=Ke[a];if(!c)continue;b=new c;Je[a]=b}c=void 0;var d=a,e=b,f=He[d],g=Ne[d]||{};Ne[d]=g;b=Math.round(L());for(c in T[d]){var h=e.b;h={client:{hl:h.Fa,gl:h.Ea,clientName:h.Da,clientVersion:h.innertubeContextClientVersion}};N("DELEGATED_SESSION_ID")&&(h.user={onBehalfOfUser:N("DELEGATED_SESSION_ID")});h={context:h};h[f]=Pe(d,c);g.dispatchedEventCount=g.dispatchedEventCount||0;g.dispatchedEventCount+=h[f].length;
h.requestTimeMs=b;var l=Me[c];if(l)a:{var m=h,w=c;if(l.videoId)var G="VIDEO";else if(l.playlistId)G="PLAYLIST";else break a;m.credentialTransferTokenTargetId=l;m.context=m.context||{};m.context.user=m.context.user||{};m.context.user.credentialTransferTokens=[{token:w,scope:G}]}delete Me[c];Se(e,d,h)}c=g;d=b;c.previousDispatchMs&&(b=d-c.previousDispatchMs,e=c.diffCount||0,c.averageTimeBetweenDispatchesMs=e?(c.averageTimeBetweenDispatchesMs*e+b)/(e+1):b,c.diffCount=e+1);c.previousDispatchMs=d;delete T[a]}Ra(T)||
Re()}}
function Re(){window.clearTimeout(Le);Le=R(Qe,N("LOGGING_BATCH_TIMEOUT",1E4))}
function Pe(a,b){b||(b="");T[a]=T[a]||{};T[a][b]=T[a][b]||[];return T[a][b]}
;function Te(a,b,c,d,e){var f={};f.eventTimeMs=Math.round(d||L());f[a]=b;f.context={lastActivityMs:String(d?-1:Ce())};b="log_event";Q("web_system_health_gel2")&&"systemHealthCaptured"==a&&(b="log_event2");Oe({endpoint:b,payload:f,Y:e},c)}
;function Ue(a,b,c){Ve(We,{attachChild:{csn:a,parentVisualElement:Ge(b),visualElements:[Ge(c)]}})}
function Ve(a,b,c){b.eventTimeMs=c?c:Math.round(L());b.lactMs=Ce();Oe({endpoint:"log_interaction",payload:b},a)}
...
var Ze,$e=new Xc;Ze=$e.isAvailable()?new Tc($e):null;var Ye,af=new Yc;Ye=af.isAvailable()?new Tc(af):null;function bf(){var a=N("client-screen-nonce")||N("EVENT_ID");return a?a:null}
function cf(){var a=N("ROOT_VE_TYPE",void 0);return a?new Ee(void 0,a,void 0):null}
...
;function ff(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=N("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=N("VALID_SESSION_TEMPDATA_DOMAINS",[]),f=$c(K(window.location.href)[3]||null);f&&e.push(f);f=$c(K(d)[3]||null);if(0<=Ea(e,f)||!f&&0==d.lastIndexOf("/",0))if(Q("autoescape_tempdata_url")&&(e=document.createElement("a"),vb(e,d),d=e.href),d){f=K(d);d=f[5];e=f[6];f=f[7];var g="";d&&(g+=d);e&&(g+="?"+e);f&&(g+="#"+f);d=g;e=d.indexOf("#");if(d=0>e?d:d.substr(0,e)){if(b.itct||b.ved)b.csn=b.csn||
bf();if(h){var h=parseInt(h,10);isFinite(h)&&0<h&&(d="ST-"+Da(d).toString(36),e=b?bd(b):"",df(d,e,h||5),ef(b))}else h="ST-"+Da(d).toString(36),d=b?bd(b):"",df(h,d,5),ef(b)}}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var m=void 0===m?"":m;var w=void 0===w?window:w;c=w.location;a=cd(a,l)+m;a=a instanceof D?a:rb(a);c.href=pb(a)}return!0}
;t("yt.abuse.botguardInitialized",u("yt.abuse.botguardInitialized")||Od,void 0);t("yt.abuse.invokeBotguard",u("yt.abuse.invokeBotguard")||Pd,void 0);t("yt.abuse.dclkstatus.checkDclkStatus",u("yt.abuse.dclkstatus.checkDclkStatus")||te,void 0);t("yt.player.exports.navigate",u("yt.player.exports.navigate")||ff,void 0);t("yt.util.activity.init",u("yt.util.activity.init")||Be,void 0);t("yt.util.activity.getTimeSinceActive",u("yt.util.activity.getTimeSinceActive")||Ce,void 0);
t("yt.util.activity.setTimestamp",u("yt.util.activity.setTimestamp")||De,void 0);function gf(a,b,c){c.context&&c.context.capabilities&&(c=c.context.capabilities,c.snapshot||c.golden)&&(a="vix");return"/youtubei/"+a+"/"+b}
;function We(a){this.b=a||{apiaryHost:O("APIARY_HOST"),gb:O("APIARY_HOST_FIRSTPARTY"),gapiHintOverride:!!N("GAPI_HINT_OVERRIDE",void 0),gapiHintParams:O("GAPI_HINT_PARAMS"),innertubeApiKey:O("INNERTUBE_API_KEY"),innertubeApiVersion:O("INNERTUBE_API_VERSION"),Da:N("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:O("INNERTUBE_CONTEXT_CLIENT_VERSION"),Fa:O("INNERTUBE_CONTEXT_HL"),Ea:O("INNERTUBE_CONTEXT_GL"),xhrApiaryHost:O("XHR_APIARY_HOST")||"",Ga:O("INNERTUBE_HOST_OVERRIDE")||""}}
function Se(a,b,c){var d={};!N("VISITOR_DATA")&&.01>Math.random()&&P(Error("Missing VISITOR_DATA when sending innertube request."),"WARNING");var e={headers:{"Content-Type":"application/json","X-Goog-Visitor-Id":N("VISITOR_DATA","")},B:c,qa:"JSON",Z:d.Z,P:function(a,b){d.P&&d.P(b)},
onError:function(a,b){if(d.onError)d.onError(b)},
timeout:d.timeout,withCredentials:!0},f=Ob();f&&(e.headers.Authorization=f,e.headers["X-Goog-AuthUser"]=N("SESSION_INDEX",0));var g="",h=a.b.Ga;h&&(g=h);f&&!g&&(e.headers["x-origin"]=window.location.origin);ee(""+g+gf(a.b.innertubeApiVersion,b,c)+"?alt=json&key="+a.b.innertubeApiKey,e)}
...
function uf(a){var b=vf(a),c=document.getElementById(b),d=c&&od(c,"loaded");d||c&&!d||(c=wf(a,b,function(){od(c,"loaded")||(rd(c),Ad(b),R(x(zd,b),0))}))}
...
function bg(a){if("_"!=a[0]){var b=a;V.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),V.mark(b))}b=cg();var c=L();b[a]&&(b["_"+a]=b["_"+a]||[b[a]],b["_"+a].push(c));b[a]=c;b=Qf();if(c=b[a])pe(c),b[a]=0;dg()["tick_"+a]=void 0;L();Q("csi_on_gel")?(b=eg(),"_start"==a?Kf("baseline_"+b)||Te("latencyActionBaselined",{clientActionNonce:b},We,void 0,void 0):Kf("tick_"+a+"_"+b)||Te("latencyActionTicked",{tickName:a,clientActionNonce:b},We,void 0,void 0),a=!0):a=!1;if(a=!a)a=!u("yt.timing.pingSent_");if(a&&
(b=O("TIMING_ACTION"),a=cg(),u("ytglobal.timingready_")&&b&&a._start&&(b=fg()))){Q("tighter_critical_section")&&!ag&&(Pf(Uf,new Sf(Math.round(b-a._start),void 0)),ag=!0);b=!0;c=N("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&gg()}}
function hg(){var a=ig().info.yt_lt="hot_bg";dg().info_yt_lt=a;if(Q("csi_on_gel"))if("yt_lt"in Yf){var b={},c=Yf.yt_lt;0<=Ea($f,c)&&(a=!!a);c=c.split(".");for(var d=b,e=0;e<c.length-1;e++)d[c[e]]=d[c[e]]||{},d=d[c[e]];b[c[c.length-1]]=a;a=eg();c=Object.keys(b).join("");Kf("info_"+c+"_"+a)||(b.clientActionNonce=a,Te("latencyActionInfo",b,We,void 0,void 0))}else 0<=Ea(Zf,"yt_lt")||P(Error("Unknown label yt_lt logged with GEL CSI."))}
function fg(){var a=cg();if(a.aft)return a.aft;for(var b=N("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
function gg(){Rf();if(!Q("csi_on_gel")){var a=cg(),b=ig().info,c=a._start,d;for(d in a)if(0==d.lastIndexOf("_",0)&&sa(a[d])){var e=d.slice(1);if(e in Xf){var f=Fa(a[d],function(a){return Math.round(a-c)});
b["all_"+e]=f.join()}delete a[d]}e=!!b.ap;if(f=u("ytglobal.timingReportbuilder_")){if(f=f(a,b,void 0))jg(f,e),kg(),lg(),mg(!1,void 0),N("TIMING_ACTION")&&M("PREVIOUS_ACTION",N("TIMING_ACTION")),M("TIMING_ACTION","")}else{var g=N("CSI_SERVICE_NAME","youtube");f={v:2,s:g,action:N("TIMING_ACTION",void 0)};var h=b.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var l=window.location.protocol+u("ytplayer.config.assets.js");(l=V.getEntriesByName?V.getEntriesByName(l)[0]:null)?b.h5jse=Math.round(b.h5jse-l.responseEnd):
delete b.h5jse}a.aft=fg();ng()&&"youtube"==g&&(hg(),g=a.vc,l=a.pbs,delete a.aft,b.aft=Math.round(l-g));for(var m in b)"_"!=m.charAt(0)&&(f[m]=b[m]);a.ps=L();b={};m=[];for(d in a)"_"!=d.charAt(0)&&(g=Math.round(a[d]-c),b[d]=g,m.push(d+"."+g));f.rt=m.join(",");(a=u("ytdebug.logTiming"))&&a(f,b);jg(f,e,void 0);Pf(Vf,new Tf(b.aft+(h||0),void 0))}}}
var lg=v(V.clearResourceTimings||V.webkitClearResourceTimings||V.mozClearResourceTimings||V.msClearResourceTimings||V.oClearResourceTimings||pa,V);
function jg(a,b,c){if(Q("debug_csi_data")){var d=u("yt.timing.csiData");d||(d=[],t("yt.timing.csiData",d,void 0));d.push({page:location.href,time:new Date,args:a})}d="";for(var e in a)d+="&"+e+"="+a[e];a="/csi_204?"+d.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b)try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,"")||he(a,void 0)}catch(f){he(a,void 0)}else he(a);mg(!0,c)}
...
;function og(a,b){F.call(this);this.o=this.j=a;this.O=b;this.A=!1;this.g={};this.U=this.N=null;this.J=new I;ec(this,x(fc,this.J));this.i={};this.G=this.V=this.h=this.da=this.b=null;this.R=!1;this.H=this.w=this.m=this.M=null;this.W={};this.ua=["onReady"];this.S=new of(this);ec(this,x(fc,this.S));this.ba=null;this.ka=NaN;this.T={};pg(this);this.C("onDetailedError",v(this.La,this));this.C("onTabOrderChange",v(this.wa,this));this.C("onTabAnnounce",v(this.la,this));this.C("WATCH_LATER_VIDEO_ADDED",v(this.Ma,
...
n(og,F);k=og.prototype;k.ja=function(a,b){this.f||(qg(this,a),rg(this,b),this.A&&sg(this))};
...
function ug(a){var b=a.b&&a.b.args;if(b&&b.fflags){var c=b.el;b=b.fflags;if((!c||"profilepage"==c)&&0<=b.indexOf("web_player_disable_flash_watch=true")||"embedded"==c&&0<=b.indexOf("web_player_disable_flash_embed=true"))return!1}if(!q(a.b.disable.flash)){c=a.b.disable;b=rf.getInstance();var d=a.b.minVersion;d="string"==typeof d?d.split("."):[d,void 0,void 0];d[0]=parseInt(d[0],10)||0;d[1]=parseInt(d[1],10)||0;d[2]=parseInt(d[2],10)||0;c.flash=!(b.major>d[0]||b.major==d[0]&&b.minor>d[1]||b.major==
d[0]&&b.minor==d[1]&&b.b>=d[2])}return!a.b.disable.flash}
function vg(a,b){var c=a.b,d=c&&c.args&&c.args.fflags;!d||0>d.indexOf("web_player_flash_fallback_killswitch=true")||b&&(5!=(xf[b.errorCode]||5)||-1==wg.indexOf(b.errorCode))||!ug(a)||((d=W(a))&&d.stopVideo&&d.stopVideo(),d&&d.getUpdatedConfigurationData&&(c=d.getUpdatedConfigurationData(),c=mf(c)),c.args.autoplay=1,c.args.html5_unavailable="1",qg(a,c),rg(a,"flash"))}
function rg(a,b){if(!a.f){if(!b){var c;if(!(c=!a.b.html5&&ug(a))){if(!q(a.b.disable.html5)){c=!0;void 0!=a.b.args.deviceHasDisplay&&(c=a.b.args.deviceHasDisplay);if(2.2==zf)var d=!0;else{a:{var e=c;c=u("yt.player.utils.videoElement_");c||(c=document.createElement("VIDEO"),t("yt.player.utils.videoElement_",c,void 0));try{if(c.canPlayType){e=e?Gf:Hf;for(var f=0;f<e.length;f++)if(c.canPlayType(e[f])){d=null;break a}}d="fmt.noneavailable"}catch(g){d="html5.missingapi"}}d=!d}d&&(d=xg(a)||a.b.assets.js);
...
function xg(a){var b=!0,c=W(a);c&&a.b&&(a=a.b,b=od(c,"version")==a.assets.js);return b&&!!u("yt.player.Application.create")}
...
this.R=!0;a?this.M():(Kd(this.b.assets.js,this.M),tf(this.b.assets.css),Ag(this)&&!b&&t("yt.player.Application.create",null,void 0))}}};
k.bb=function(){var a=nf(this.b);if(!this.w){var b=W(this);b&&(this.w=document.createElement("SPAN"),this.w.tabIndex=0,pf(this.S,this.w,"focus",this.oa),this.H=document.createElement("SPAN"),this.H.tabIndex=0,pf(this.S,this.H,"focus",this.oa),b.parentNode&&b.parentNode.insertBefore(this.w,b),b.parentNode&&b.parentNode.insertBefore(this.H,b.nextSibling))}a.attrs.width=a.attrs.width||"100%";a.attrs.height=a.attrs.height||"100%";if("flash"==yg(this))this.G="flash",this.A||this.L();else{zg(this);this.G=
"flash";this.b.loaded=!0;window!=window.top&&document.referrer&&(a.args.framer=document.referrer.substring(0,128));b=this.j;var c=a.url;if(c){b=r(b)?zb(b):b;var d=Ta(a.attrs);d.tabindex=0;var e=Ta(a.params);e.flashvars=bd(a.args);if(id){d.classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000";e.movie=c;a=document.createElement("object");for(var f in d)a.setAttribute(f,d[f]);for(var g in e)f=document.createElement("param"),f.setAttribute("name",g),f.setAttribute("value",e[g]),a.appendChild(f)}else{d.type=
...
function W(a){var b=zb(a.h);!b&&a.o&&a.o.querySelector&&(b=a.o.querySelector("#"+a.h));return b}
k.L=function(){if(!this.f){var a=W(this),b=!1;try{a&&a.getApiInterface&&a.getApiInterface()&&(b=!0)}catch(f){}if(b)if(this.R=!1,a.isNotServable&&a.isNotServable(this.b.args.video_id))vg(this);else{pg(this);this.A=!0;a=W(this);a.addEventListener&&(this.N=Bg(this,a,"addEventListener"));a.removeEventListener&&(this.U=Bg(this,a,"removeEventListener"));b=a.getApiInterface();b=b.concat(a.getInternalApiInterface());for(var c=0;c<b.length;c++){var d=b[c];this.g[d]||(this.g[d]=Bg(this,a,d))}for(var e in this.i)this.N(e,
this.i[e]);sg(this);this.V&&this.V(this.g);this.J.K("onReady",this.g)}else this.ka=R(v(this.L,this),50)}};
function Bg(a,b,c){var d=b[c];return function(){try{return a.ba=null,d.apply(b,arguments)}catch(e){"Bad NPObject as private data!"!=e.message&&"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.ba=e,P(e,"WARNING"))}}}
...
k.C=function(a,b){if(!this.f){var c=tg(this,b);if(c){if(!(0<=Ea(this.ua,a)||this.i[a])){var d=Cg(this,a);this.N&&this.N(a,d)}this.J.subscribe(a,c);"onReady"==a&&this.A&&R(x(c,this.g),0)}}};
k.Sa=function(a,b){if(!this.f){var c=tg(this,b);c&&Nc(this.J,a,c)}};
...
function Cg(a,b){var c="ytPlayer"+b+a.O,d=v(function(a){if("html5"==yg(this)){var c=this.b&&this.b.args&&this.b.args.fflags;if(c&&0>c.indexOf("use_html5_player_event_timeout=true")){this.J.K(b,a);return}}var d=R(v(function(){if(!this.f){this.J.K(b,a);var c=this.T,e=String(d);e in c&&delete c[e]}},this),0);
...
function yg(a){return(a=W(a))?"div"==a.tagName.toLowerCase()?"html5":"flash":null}
function zg(a){bg("dcp");a.cancel();pg(a);a.G=null;a.b&&(a.b.loaded=!1);var b=W(a);"html5"==yg(a)?xg(a)||!Ag(a)?a.m=b:(b&&b.destroy&&b.destroy(),a.m=null):b&&b.destroy&&b.destroy();b=a.j;for(var c;c=b.firstChild;)b.removeChild(c);qf(a.S);a.w=null;a.H=null}
k.cancel=function(){this.M&&Jd(this.b.assets.js,this.M);window.clearTimeout(this.ka);this.R=!1};
k.l=function(){zg(this);if(this.m&&this.b&&this.m.destroy)try{this.m.destroy()}catch(b){P(b)}this.W=null;for(var a in this.i)p[this.i[a]]=null;this.da=this.b=this.g=null;delete this.j;delete this.o;F.prototype.l.call(this)};
function Ag(a){return a.b&&a.b.args&&a.b.args.fflags?-1!=a.b.args.fflags.indexOf("player_destroy_old_version=true"):!1}
var wg=["fmt.noneavailable","html5.missingapi","html5.unsupportedads","html5.unsupportedlive"];var Dg={},Eg="player_uid_"+(1E9*Math.random()>>>0);function Fg(a){delete Dg[a.O]}
function Gg(a){var b="player";b=r(b)?zb(b):b;a=mf(a);var c=Eg+"_"+(b[xa]||(b[xa]=++ya)),d=Dg[c];if(d)return d.ja(a),d.g;d=new og(b,c);Dg[c]=d;Ad("player-added",d.g);ec(d,x(Fg,d));R(function(){d.ja(a)},0);
return d.g}
;function Hg(a,b,c){if(wa(a)){b="endSeconds startSeconds mediaContentUrl suggestedQuality videoId two_stage_token".split(" ");c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function Ig(a,b,c){r(a)&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});b=/\/([ve]|embed)\/([^#?]+)/.exec(a.mediaContentUrl);a.videoId=b&&b[2]?b[2]:null;return Hg(a)}
function Jg(a,b,c,d){if(wa(a)&&!sa(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};r(a)&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
function X(a){var b=a.video_id||a.videoId;if(r(b)){var c=Xe()||{},d=Xe()||{};q(void 0)?d[b]=void 0:delete d[b];var e=y()+3E5,f=Ze;if(f&&window.JSON){r(d)||(d=JSON.stringify(d,void 0));try{f.set("yt-player-two-stage-token",d,e)}catch(g){f.remove("yt-player-two-stage-token")}}(b=c[b])&&(a.two_stage_token=b)}}
function Kg(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
;function Lg(a){F.call(this);this.g=a;this.g.subscribe("command",this.ra,this);this.h={};this.i=!1}
z(Lg,F);k=Lg.prototype;k.start=function(){this.i||this.f||(this.i=!0,Mg(this.g,"RECEIVING"))};
k.ra=function(a,b){if(this.i&&!this.f){var c=b||{};switch(a){case "addEventListener":if(r(c.event)&&(c=c.event,!(c in this.h))){var d=v(this.Ua,this,c);this.h[c]=d;this.addEventListener(c,d)}break;case "removeEventListener":r(c.event)&&Ng(this,c.event);break;default:this.b.isReady()&&this.b[a]&&(c=Og(a,b||{}),c=this.b[a].apply(this.b,c),(c=Pg(a,c))&&this.i&&!this.f&&Mg(this.g,a,c))}}};
k.Ua=function(a,b){this.i&&!this.f&&Mg(this.g,a,this.ea(a,b))};
k.ea=function(a,b){if(null!=b)return{value:b}};
function Ng(a,b){b in a.h&&(a.removeEventListener(b,a.h[b]),delete a.h[b])}
k.l=function(){var a=this.g;a.f||Nc(a.b,"command",this.ra,this);this.g=null;for(var b in this.h)Ng(this,b);Lg.u.l.call(this)};function Y(a,b){Lg.call(this,b);this.b=a;this.start()}
z(Y,Lg);Y.prototype.addEventListener=function(a,b){this.b.addEventListener(a,b)};
Y.prototype.removeEventListener=function(a,b){this.b.removeEventListener(a,b)};
function Og(a,b){switch(a){case "loadVideoById":return b=Hg(b),X(b),[b];case "cueVideoById":return b=Hg(b),X(b),[b];case "loadVideoByPlayerVars":return X(b),[b];case "cueVideoByPlayerVars":return X(b),[b];case "loadPlaylist":return b=Jg(b),X(b),[b];case "cuePlaylist":return b=Jg(b),X(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];
...
Y.prototype.ea=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return Y.u.ea.call(this,a,b)};
Y.prototype.l=function(){Y.u.l.call(this);delete this.b};function Qg(a,b,c,d){F.call(this);this.g=b||null;this.o="*";this.h=c||null;this.sessionId=null;this.channel=d||null;this.A=!!a;this.m=v(this.w,this);window.addEventListener("message",this.m)}
n(Qg,F);Qg.prototype.w=function(a){if(!("*"!=this.h&&a.origin!=this.h||this.g&&a.source!=this.g)&&r(a.data)){try{var b=nc(a.data)}catch(c){return}if(!(null==b||this.A&&(this.sessionId&&this.sessionId!=b.id||this.channel&&this.channel!=b.channel))&&b)switch(b.event){case "listening":"null"!=a.origin&&(this.h=this.o=a.origin);this.g=a.source;this.sessionId=b.id;this.b&&(this.b(),this.b=null);break;case "command":this.i&&(!this.j||0<=Ea(this.j,b.func))&&this.i(b.func,b.args)}}};
Qg.prototype.sendMessage=function(a,b){var c=b||this.g;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=oc(a);c.postMessage(d,this.o)}catch(e){P(e,"WARNING")}}};
Qg.prototype.l=function(){window.removeEventListener("message",this.m);F.prototype.l.call(this)};function Rg(a,b,c){Qg.call(this,a,b,c||N("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.j=this.b=this.i=null}
n(Rg,Qg);function Sg(){var a=!!N("WIDGET_ID_ENFORCE");a=this.f=new Rg(a);var b=v(this.Ra,this);a.i=b;a.j=null;this.f.channel="widget";if(a=N("WIDGET_ID"))this.f.sessionId=a;this.h=[];this.j=!1;this.i={}}
k=Sg.prototype;k.Ra=function(a,b){if("addEventListener"==a&&b){var c=b[0];this.i[c]||"onReady"==c||(this.addEventListener(c,Tg(this,c)),this.i[c]=!0)}else this.ta(a,b)};
k.ta=function(){};
function Tg(a,b){return v(function(a){this.sendMessage(b,a)},a)}
k.addEventListener=function(){};
k.ya=function(){this.j=!0;this.sendMessage("initialDelivery",this.fa());this.sendMessage("onReady");B(this.h,this.sa,this);this.h=[]};
k.fa=function(){return null};
function Ug(a,b){a.sendMessage("infoDelivery",b)}
k.sa=function(a){this.j?this.f.sendMessage(a):this.h.push(a)};
k.sendMessage=function(a,b){this.sa({event:a,info:void 0==b?null:b})};
k.dispose=function(){this.f=null};function Vg(a){Sg.call(this);this.b=a;this.g=[];this.addEventListener("onReady",v(this.Oa,this));this.addEventListener("onVideoProgress",v(this.Ya,this));this.addEventListener("onVolumeChange",v(this.Za,this));this.addEventListener("onApiChange",v(this.Ta,this));this.addEventListener("onPlaybackQualityChange",v(this.Va,this));this.addEventListener("onPlaybackRateChange",v(this.Wa,this));this.addEventListener("onStateChange",v(this.Xa,this))}
z(Vg,Sg);k=Vg.prototype;k.ta=function(a,b){if(this.b[a]){b=b||[];if(0<b.length&&Kg(a)){var c=b;if(wa(c[0])&&!sa(c[0]))c=c[0];else{var d={};switch(a){case "loadVideoById":case "cueVideoById":d=Hg.apply(window,c);break;case "loadVideoByUrl":case "cueVideoByUrl":d=Ig.apply(window,c);break;case "loadPlaylist":case "cuePlaylist":d=Jg.apply(window,c)}c=d}X(c);b.length=1;b[0]=c}this.b[a].apply(this.b,b);Kg(a)&&Ug(this,this.fa())}};
...
mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());this.b.getStoryboardFormat&&(a.storyboardFormat=this.b.getStoryboardFormat());Ug(this,a)};
k.Va=function(a){Ug(this,{playbackQuality:a})};
k.Wa=function(a){Ug(this,{playbackRate:a})};
...
k.Za=function(){Ug(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
k.Ya=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:y()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());Ug(this,a)};
k.dispose=function(){Vg.u.dispose.call(this);for(var a=0;a<this.g.length;a++){var b=this.g[a];this.b.removeEventListener(b.eventType,b.listener)}this.g=[]};function Wg(){F.call(this);this.b=new I;ec(this,x(fc,this.b))}
z(Wg,F);Wg.prototype.subscribe=function(a,b,c){return this.f?0:this.b.subscribe(a,b,c)};
Wg.prototype.D=function(a){return this.f?!1:this.b.D(a)};
Wg.prototype.j=function(a,b){this.f||this.b.K.apply(this.b,arguments)};function Xg(a,b,c){Wg.call(this);this.g=a;this.h=b;this.i=c}
z(Xg,Wg);function Mg(a,b,c){if(!a.f){var d=a.g;d.f||a.h!=d.b||(a={id:a.i,command:b},c&&(a.data=c),d.b.postMessage(oc(a),d.h))}}
Xg.prototype.l=function(){this.h=this.g=null;Xg.u.l.call(this)};function Yg(a,b,c){F.call(this);this.b=a;this.h=c;this.i=ze(window,"message",v(this.j,this));this.g=new Xg(this,a,b);ec(this,x(fc,this.g))}
z(Yg,F);Yg.prototype.j=function(a){var b;if(b=!this.f)if(b=a.origin==this.h)a:{b=this.b;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(a=a.data,r(a))){try{a=nc(a)}catch(d){return}a.command&&(b=this.g,b.f||b.j("command",a.command,a.data))}};
Yg.prototype.l=function(){Ae(this.i);this.b=null;Yg.u.l.call(this)};function Zg(){var a=Oa(window,"settings","experiments","flags","html5_serverside_pagead_id_sets_cookie")||N("EXP_HTML5_SERVERSIDE_PAGEAD_ID_SETS_COOKIE",!1)||Q("html5_serverside_pagead_id_sets_cookie")?"//googleads.g.doubleclick.net/pagead/id?exp=nomnom":"//googleads.g.doubleclick.net/pagead/id",b=Ta($g);return new H(function(c,d){b.P=function(a){Sd(a)?c(a):d(new ah("Request failed, status="+a.status,"net.badstatus"))};
b.onError=function(){d(new ah("Unknown request error","net.unknown"))};
b.Z=function(){d(new ah("Request timed out","net.timeout"))};
Zd(a,b)})}
var bh={eb:"net.badstatus",fb:"net.retryexhausted",TIMEOUT:"net.timeout",UNKNOWN:"net.unknown"};function ah(a,b){A.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
n(ah,A);var ch=ah;function dh(a){this.g=void 0===a?null:a;this.f=0;this.b=null}
dh.prototype.then=function(a,b,c){return this.g?this.g.then(a,b,c):1===this.f&&a?(a=a.call(c,this.b),vc(a)?a:eh(a)):2===this.f&&b?(a=b.call(c,this.b),vc(a)?a:fh(a)):this};
dh.prototype.getValue=function(){return this.b};
uc(dh);function fh(a){var b=new dh;a=void 0===a?null:a;b.f=2;b.b=void 0===a?null:a;return b}
function eh(a){var b=new dh;a=void 0===a?null:a;b.f=1;b.b=void 0===a?null:a;return b}
;function gh(a){A.call(this,a.message||a.description||a.name);this.isMissing=a instanceof hh;this.isTimeout=a instanceof ch&&a.errorCode==bh.TIMEOUT;this.isCanceled=a instanceof Dc}
n(gh,A);gh.prototype.name="BiscottiError";function hh(){A.call(this,"Biscotti ID is missing from server")}
n(hh,A);hh.prototype.name="BiscottiMissingError";var $g={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},ih=null;function jh(){if("1"===Oa(N("PLAYER_CONFIG",{}),"args","privembed"))return Ac(Error("Biscotti ID is not available in private embed mode"));ih||(ih=Cc(Zg().then(kh),function(a){return lh(2,a)}));
return ih}
...
function nh(a,b){R(function(){Cc(Zg().then(kh,function(a){return lh(b,a)}),pa)},a)}
function mh(a){t("yt.ads.biscotti.lastId_",a,void 0)}
;function oh(){}
function ph(a){if("1"!==Oa(N("PLAYER_CONFIG",{}),"args","privembed")){a&&!u("yt.ads.biscotti.getId_")&&t("yt.ads.biscotti.getId_",jh,void 0);try{try{var b=u("yt.ads.biscotti.getId_");var c=b?b():jh()}catch(d){c=Ac(d)}c.then(qh,oh);R(ph,18E5)}catch(d){P(d)}}}
var rh=0;
function qh(a){a:{try{var b=window.top.location.href}catch(Ma){b=2;break a}b=null!=b?b==window.document.location.href?0:1:2}b={dt:Hb,flash:hd||"0",frm:b};b.u_tz=-(new Date).getTimezoneOffset();var c=void 0===c?E:c;try{var d=c.history.length}catch(Ma){d=0}b.u_his=d;b.u_java=!!E.navigator&&"unknown"!==typeof E.navigator.javaEnabled&&!!E.navigator.javaEnabled&&E.navigator.javaEnabled();E.screen&&(b.u_h=E.screen.height,b.u_w=E.screen.width,b.u_ah=E.screen.availHeight,b.u_aw=E.screen.availWidth,b.u_cd=
E.screen.colorDepth);E.navigator&&E.navigator.plugins&&(b.u_nplug=E.navigator.plugins.length);E.navigator&&E.navigator.mimeTypes&&(b.u_nmime=E.navigator.mimeTypes.length);b.bid=a;b.ca_type=gd?"flash":"image";if(Q("enable_server_side_search_pyv")||Q("enable_server_side_mweb_search_pyv")){a=window;try{var e=a.screenX;var f=a.screenY}catch(Ma){}try{var g=a.outerWidth;var h=a.outerHeight}catch(Ma){}try{var l=a.innerWidth;var m=a.innerHeight}catch(Ma){}e=[a.screenLeft,a.screenTop,e,f,a.screen?a.screen.availWidth:
void 0,a.screen?a.screen.availTop:void 0,g,h,l,m];f=window.top;try{if(f.document&&!f.document.body)var w=new yb(-1,-1);else{var G=(f||window).document,pd="CSS1Compat"==G.compatMode?G.documentElement:G.body;w=(new yb(pd.clientWidth,pd.clientHeight)).round()}var va=w}catch(Ma){va=new yb(-12245933,-12245933)}w=0;p.SVGElement&&p.document.createElementNS&&(w|=1);va={bc:w,bih:va.height,biw:va.width,brdim:e.join(),vis:{visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[Fb.webkitVisibilityState||Fb.mozVisibilityState||
Fb.visibilityState||""]||0,wgl:!!E.WebGLRenderingContext};for(var qd in va)b[qd]=va[qd]}b.bsq=rh++;ee("//www.youtube.com/ad_data_204",{Ca:!1,B:b})}
;var Z=u("ytglobal.prefsUserPrefsPrefs_")||{};t("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function sh(){this.b=N("ALT_PREF_COOKIE_NAME","PREF");var a=Nb.get(""+this.b,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
sh.prototype.get=function(a,b){th(a);uh(a);var c=void 0!==Z[a]?Z[a].toString():null;return null!=c?c:b?b:""};
sh.prototype.set=function(a,b){th(a);uh(a);if(null==b)throw Error("ExpectedNotNull");Z[a]=b.toString()};
sh.prototype.remove=function(a){th(a);uh(a);delete Z[a]};
sh.prototype.clear=function(){for(var a in Z)delete Z[a]};
...
qa(sh);var wh=null,xh=null,yh=null,zh={};function Ah(a){Te(a.payload_name,a.payload,We,void 0,void 0)}
function Bh(a){var b=a.id;a=a.ve_type;var c=Fe++;a=new Ee(void 0,a,c,void 0,void 0);zh[b]=a;b=bf();c=cf();b&&c&&Ue(b,c,a)}
function Ch(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(M("client-screen-nonce",b),M("ROOT_VE_TYPE",a),a=cf()))for(var c in zh){var d=zh[c];d&&Ue(b,a,d)}}
function Dh(a){zh[a.id]=new Ee(a.tracking_params)}
function Eh(a){var b=a.id;a=bf();b=zh[b];a&&b&&Ve(We,{click:{csn:a,visualElement:Ge(b)}})}
function Fh(a){a=a.ids;var b=bf();if(b)for(var c=0;c<a.length;c++){var d=zh[a[c]];if(d){var e=b,f=We;Q("interaction_logging_on_gel_web")?Te("visualElementShown",{csn:e,ve:Ge(d),eventType:1},f):Ve(f,{visibilityUpdate:{csn:e,visualElements:[Ge(d)]}},void 0)}}}
function Gh(){var a=wh;a&&a.startInteractionLogging&&a.startInteractionLogging()}
...
t("writeEmbed",function(){var a=N("PLAYER_CONFIG",void 0);ph(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=N("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);N("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&X(a.args);wh=a=Gg(a);a.addEventListener("onScreenChanged",Ch);a.addEventListener("onLogClientVeCreated",Bh);a.addEventListener("onLogServerVeCreated",Dh);a.addEventListener("onLogToGel",Ah);
a.addEventListener("onLogVeClicked",Eh);a.addEventListener("onLogVesShown",Fh);a.addEventListener("onReady",Gh);b=N("POST_MESSAGE_ID","player");N("ENABLE_JS_API")?yh=new Vg(a):N("ENABLE_POST_API")&&r(b)&&r(c)&&(xh=new Yg(window.parent,b,c),yh=new Y(a,xh.g));N("BG_P")&&(N("BG_I")||N("BG_IU"))&&Md();se()},void 0);
t("yt.www.watch.ads.restrictioncookie.spr",function(a){he(a+"mac_204?action_fcts=1");return!0},void 0);
var Hh=ld(function(){bg("ol");var a=sh.getInstance(),b=1<window.devicePixelRatio;if(!!((vh("f"+(Math.floor(119/31)+1))||0)&67108864)!=b){var c="f"+(Math.floor(119/31)+1),d=vh(c)||0;d=b?d|67108864:d&-67108865;0==d?delete Z[c]:Z[c]=d.toString(16).toString();a=a.b;b=[];for(var e in Z)b.push(e+"="+encodeURIComponent(String(Z[e])));df(a,b.join("&"),63072E3)}}),Ih=ld(function(){var a=wh;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();N("PL_ATT")&&(Ld=null);a=0;for(var b=qe.length;a<b;a++)pe(qe[a]);qe.length=0;Id("//static.doubleclick.net/instream/ad_status.js");re=!1;M("DCLKSTAT",0);gc(yh,xh);if(a=wh)a.removeEventListener("onScreenChanged",Ch),a.removeEventListener("onLogClientVeCreated",Bh),a.removeEventListener("onLogServerVeCreated",Dh),a.removeEventListener("onLogToGel",Ah),a.removeEventListener("onLogVeClicked",Eh),a.removeEventListener("onLogVesShown",Fh),a.removeEventListener("onReady",
Gh),a.destroy();zh={}});
window.addEventListener?(window.addEventListener("load",Hh),window.addEventListener("unload",Ih)):window.attachEvent&&(window.attachEvent("onload",Hh),window.attachEvent("onunload",Ih));}).call(this);
